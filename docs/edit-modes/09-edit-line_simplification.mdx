...
|:-------------------------------------------------------|:----------|:-------------------------------------------------------------------------------------|
| `enableMode('edit', 'line_simplification')`            | -         | Enables global Line Simplification Mode.                                             |
| `disableMode('edit', 'line_simplification')`           | -         | Disables global Line Simplification Mode.                                            |
| `toggleMode('edit', 'line_simplification')`            | -         | Toggles global Line Simplification Mode.                                             |
| `isModeEnabled('edit', 'line_simplification')`         | `Boolean` | Returns `true` if global Line Simplification Mode is enabled. `false` when disabled. |
